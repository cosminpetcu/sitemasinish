                ...
                <div className="mb-2">
                    ...
                    {properties.length > 0 && properties.map((property,index) => (
                        <div key={property._id} className="flex gap-1 mb-2">
                            ...
                            <input type="text" value={property.values} className="mb-0" onChange={ev => handlePropertyValuesChange(index,property,ev.target.value)} placeholder="values, comma separated"/>
                        ...
                        <tr key={category._id}>
                            ...
                            <td className="flex">
                                <button
                                    ...
                                    className="btn-default px-4 rounded-sm inline-flex mx-1 items-center gap-1 text-sm py-1">
                                ...
                                <button
                                    ...
                                    className="btn-red px-4 rounded-sm inline-flex mx-1 items-center gap-1 text-sm py-1">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
